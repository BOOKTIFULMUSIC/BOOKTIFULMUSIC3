...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/notice_Update_Form.css">
	...
	<!-- content 부분-->
        <div class="content">
            <div id="section">
                ...
                <div id="menu_name">
                    <p id="title">문의 수정하기</p>
                </div>

                <div class="notice_title">
                    <form action="<%=request.getContextPath()%>/nUpdateNotice.no" method="post">
                        <table id="notice_text">
                            <tr>
                                <td class="category"><strong>문의유형</strong></td>
                                <td id="type_text">
                              <%if(n.getNtype().equals("P")) {%>
                            ...
                            <tr>
                                ...
                                <td id="writer_text">
                                    <input type="text" value="<%=n.getNwriter()%>" name="nwriter" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td class="category"><strong>제목</strong></td>
                                <td id="title_text">
                                    <input type="text" name="ntitle" value="<%=n.getNtitle()%>">
                                </td>
                            </tr>    
                            <tr>
                                <td class="category"><strong>내용</strong></td>
                                <td id="content_text">
                                    <textarea name="ncontent"><%=n.getNcontent()%></textarea>
                                </td>
                            </tr>
                        </table>
                        ...
                        <input type="hidden" name="rnum" value="<%=n.getRnum()%>"/>
